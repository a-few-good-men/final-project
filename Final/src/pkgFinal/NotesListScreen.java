...
//------------------------------------------------------------------------------
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        ...
        addNoteScreen addNote   =   new addNoteScreen(loggedInUser, table.getSelectedRow());
...
//------------------------------------------------------------------------------
        ...
        Object[] row;
        for (User u : mainScreen.noteList) {
            row=convert(n);     
            model.addRow(row);
        }
...
//------------------------------------------------------------------------------
    private Object[] convert(Note n){     
        Object[] row = { n.username, n.secLevel};
